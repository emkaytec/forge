...
func TestRemoteExecutorWiresTFCProvisionerRoleARNToWorkspaceVariable(t *testing.T) {
	roleClient := &fakeRoleBindingClient{roles: map[string]*iamcli.Role{
		"sample-dev-provisioner-role": {ARN: "arn:aws:iam::123456789012:role/sample-dev-provisioner-role"},
	}}
	...
	if variable.Value != "arn:aws:iam::123456789012:role/sample-dev-provisioner-role" {
...
func TestRemoteExecutorUpdatesTFCProvisionerRoleARNWhenCreateReportsAlreadyExists(t *testing.T) {
	...
	if hcpClient.updatedVariable.Value != "arn:aws:iam::123456789012:role/sample-dev-provisioner-role" {
...
func TestRemoteExecutorUpdatesGitHubProvisionerRoleARNWhenCreateReportsAlreadyExists(t *testing.T) {
	...
	if githubClient.updatedVariable.Value != "arn:aws:iam::123456789012:role/sample-dev-provisioner-role" {
